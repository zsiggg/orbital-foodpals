...
import { NewOrderDto, RestaurantDto } from "types";
        ...
        return (<>
            ...
            <Alert />
                <div className="h-[30vh] w-full relative flex flex-col justify-center items-center">
                    {imgSrc ? <Image src={imgSrc} layout="fill" objectFit="contain" alt="Restaurant Pic"/> : <p className="text-center">Loading...</p>}
                </div>
                ...
                <a className="flex p-5 rounded-lg mt-4 justify-between items-center w-full shadow-sm bg-white border border-gray-300 font-medium" href={restaurant.menu_link} target="_blank" rel="noreferrer">
                    <span>Menu</span>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <textarea className="w-full resize-none p-5" rows={10} onChange={e => setOrderText(e.target.value)}
                    placeholder={"Be as detailed as possible!\ne.g. 1x 6pc Chicken McNuggets ala carte, curry sauce"} />
                    <input type="submit" className="p-5 w-full rounded-xl shadow-sm bg-gray-200 hover:bg-gray-300 hover:border hover:border-gray-400 text-lg font-medium" value="Submit Order"/>
                </form> 
            </div>
        </>)    
    } else {
