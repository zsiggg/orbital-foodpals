...
export const CurrentOrderMap = ({
  ...
  useEffect(() => {
    ...
    deliveryMarkerRef.current = new mapboxgl.Marker({ color: '#10b981' })
      .setLngLat(deliveryLocation)
      .addTo(mapRef.current)
    mapRef.current.addControl(new mapboxgl.NavigationControl(), 'bottom-right')

    const geolocateControl: mapboxgl.GeolocateControl =
    ...
    geolocateControl.on('error', () => {
      // try to trigger() again after timeout
