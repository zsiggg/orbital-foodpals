...
export const accomodationArr: string[][] = [
    ...
    ["Ridge View Residential College", "College of Alice & Peter Tan", "Residential College 4", "Tembusu College", "NUS College"],
    ["LightHouse", "Pioneer House"],
    ["PGP Residence", "UTown Residence"]
]

export default ({ selectedAccomodation, setSelectedAccomodation, id }) => {
